// ESSlashDateFormatParser.swift - Parser for dates in European slash/dot format (DD/MM/YYYY)
import Foundation

/// Parser for Spanish little-endian numeric dates (e.g., 31/12/2021, 31.12, 31-12-2021, 15.6).
///
/// Accepts ".", "/" and "-" as separators so dotted "dd.mm" dates (common in Spain) are
...
public final class ESSlashDateFormatParser: Parser {
    ...
    public func pattern(context: ParsingContext) -> String {
        return ESSlashDateFormatParser.PATTERN
    }

    /// Extracts date from slash/dot format expressions (Spanish format: DD/MM/YYYY)
    public func extract(context: ParsingContext, match: TextMatch) -> Any? {
        ...
        component.addTag("ESSlashDateFormatParser")
        return component
    }
}
